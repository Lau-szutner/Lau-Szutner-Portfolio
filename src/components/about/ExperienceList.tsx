...
const ExperienceList: React.FC<Props> = ({ icon, children }) => {
  return (
    <div className="h-fit !box-border relative group">
      ...
      <div className="relative z-10 bg-neutral-800 text-white p-5 rounded-md border-2 border-neutral-700 hover:border-[#00ffea] grid gap-5 lg:grid-cols-[0.1fr_1fr]">
